...
## 10. Facts: removal, and why it is not the same problem
...
### 10.1 Facts have the same defect events had, and no way out of it
...
ever — exactly the shape of §1.3's complaint about events.
...
### 10.2 The only removal available destroys history
...
### 10.3 Why fact expiry is not event expiry
...
### 10.5 What interacts with the events work

Mostly nothing, which is the useful conclusion — but two points connect:
