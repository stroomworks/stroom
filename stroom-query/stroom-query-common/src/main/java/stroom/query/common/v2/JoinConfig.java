...
public class JoinConfig extends AbstractConfig implements IsStroomConfig {
     ...
     * {@code docs/join-scalability-implementation-plan.md}, §12 items C1/C2). The streaming probe (left) side is
     ...
     * see {@code docs/join-scalability-implementation-plan.md}, §12 items C1/A6. Below this, the build side is a
