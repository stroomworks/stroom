...
@FunctionDef(
        ...
        commonReturnDescription = "The absolute (non-negative) value of the supplied value.",
        signatures = @FunctionSignature(
                description = "The absolute (non-negative) value of the supplied value.",
                args = @FunctionArg(
                        name = "value",
                        description = "Numeric field, function or a constant.",
                        argType = ValNumber.class)))
class Abs extends NumericFunction {

    static final String NAME = "abs";
    private static final Calc CALC = new Calc();

    public Abs(final String name) {
        super(name, 1, 1);
    }
