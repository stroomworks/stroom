...
@FunctionDef(
        ...
        commonReturnDescription = "The square root of the supplied value.",
        signatures = @FunctionSignature(
                description = "The square root of the supplied value.",
                args = @FunctionArg(
                        name = "value",
                        description = "Numeric field, function or a constant.",
                        argType = ValNumber.class)))
class Sqrt extends NumericFunction {

    static final String NAME = "sqrt";
    private static final Calc CALC = new Calc();

    public Sqrt(final String name) {
        super(name, 1, 1);
    }
