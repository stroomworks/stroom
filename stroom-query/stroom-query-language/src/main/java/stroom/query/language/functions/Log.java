...
@FunctionDef(
        ...
        commonReturnDescription = "The natural logarithm (base e) of the supplied value.",
        signatures = @FunctionSignature(
                description = "The natural logarithm (base e) of the supplied value.",
                args = @FunctionArg(
                        name = "value",
                        description = "Numeric field, function or a constant.",
                        argType = ValNumber.class)))
class Log extends NumericFunction {
