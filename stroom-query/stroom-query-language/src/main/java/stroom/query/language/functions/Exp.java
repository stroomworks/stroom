...
@FunctionDef(
        ...
        commonReturnDescription = "Euler's number e raised to the power of the supplied value.",
        signatures = @FunctionSignature(
                description = "Euler's number e raised to the power of the supplied value.",
                args = @FunctionArg(
                        name = "value",
                        description = "Numeric field, function or a constant.",
                        argType = ValNumber.class)))
class Exp extends NumericFunction {

    static final String NAME = "exp";
    private static final Calc CALC = new Calc();

    public Exp(final String name) {
        super(name, 1, 1);
    }
