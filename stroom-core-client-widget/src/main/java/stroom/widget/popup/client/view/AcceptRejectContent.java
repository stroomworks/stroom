...
public class AcceptRejectContent extends Composite implements DialogButtons {

    private static final Binder binder = GWT.create(Binder.class);

    public interface Binder extends UiBinder<Widget, AcceptRejectContent> {
    ...
    public AcceptRejectContent(final HideRequestUiHandlers uiHandlers) {
