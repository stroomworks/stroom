    ...
    private Query getTermQuery(final ExpressionTerm term,
        ...
        if (FieldType.INTEGER.equals(indexField.getFldType())) {
            switch (condition) {
                ...
                case GREATER_THAN -> {
                    return IntField.newRangeQuery(fieldName, getInt(fieldName, value) + 1, Integer.MAX_VALUE);
                }
                case GREATER_THAN_OR_EQUAL_TO -> {
                    return IntField.newRangeQuery(fieldName, getInt(fieldName, value), Integer.MAX_VALUE);
                }
                case LESS_THAN -> {
                    return IntField.newRangeQuery(fieldName, Integer.MIN_VALUE, getInt(fieldName, value) - 1);
                }
                case LESS_THAN_OR_EQUAL_TO -> {
                    return IntField.newRangeQuery(fieldName, Integer.MIN_VALUE, getInt(fieldName, value));
                }
                case BETWEEN -> {
                    ...
                    return IntField.newRangeQuery(fieldName, between[0], between[1]);
                }
                case IN -> {
            ...
            switch (condition) {
                ...
                case GREATER_THAN -> {
                    return LongField.newRangeQuery(fieldName, getLong(fieldName, value) + 1, Long.MAX_VALUE);
                }
                case GREATER_THAN_OR_EQUAL_TO -> {
                    return LongField.newRangeQuery(fieldName, getLong(fieldName, value), Long.MAX_VALUE);
                }
                case LESS_THAN -> {
                    return LongField.newRangeQuery(fieldName, Long.MIN_VALUE, getLong(fieldName, value) - 1);
                }
                case LESS_THAN_OR_EQUAL_TO -> {
                    return LongField.newRangeQuery(fieldName, Long.MIN_VALUE, getLong(fieldName, value));
                }
                case BETWEEN -> {
                    ...
                    return LongField.newRangeQuery(fieldName, between[0], between[1]);
                }
                case IN -> {
            ...
            switch (condition) {
                ...
                case GREATER_THAN -> {
                    return FloatField.newRangeQuery(fieldName,
                            getFloat(fieldName, value) + Float.MIN_VALUE,
                            Float.MAX_VALUE);
                }
                case GREATER_THAN_OR_EQUAL_TO -> {
                    return FloatField.newRangeQuery(fieldName, getFloat(fieldName, value), Float.MAX_VALUE);
                }
                case LESS_THAN -> {
                ...
                case BETWEEN -> {
                    ...
                    return FloatField.newRangeQuery(fieldName, between[0], between[1]);
                }
                case IN -> {
            ...
            switch (condition) {
                ...
                case GREATER_THAN -> {
                    return DoubleField.newRangeQuery(fieldName,
                            getDouble(fieldName, value) + Double.MIN_VALUE,
                            Double.MAX_VALUE);
                }
                case GREATER_THAN_OR_EQUAL_TO -> {
                    return DoubleField.newRangeQuery(fieldName,
                ...
                case BETWEEN -> {
                    ...
                    return DoubleField.newRangeQuery(fieldName, between[0], between[1]);
                }
                case IN -> {
            ...
            switch (condition) {
                ...
                case GREATER_THAN -> {
                    return LongField.newRangeQuery(fieldName,
                            getDate(fieldName, value) + 1,
                            Long.MAX_VALUE);
                }
                case GREATER_THAN_OR_EQUAL_TO -> {
                    return LongField.newRangeQuery(fieldName, getDate(fieldName, value), Long.MAX_VALUE);
                }
                case LESS_THAN -> {
                    return LongField.newRangeQuery(fieldName, Long.MIN_VALUE, getDate(fieldName, value) - 1);
                }
                case LESS_THAN_OR_EQUAL_TO -> {
                    return LongField.newRangeQuery(fieldName, Long.MIN_VALUE, getDate(fieldName, value));
                }
                case BETWEEN -> {
...
//                    return getSubQuery(matchVersion, indexField, value, terms, false);
    ...
    private Query getIntIn(final String fieldName, final String value) {
        ...
        if (in.length > 0) {
            if (in.length == 1) {
                final int num = in[0];
                return IntField.newExactQuery(fieldName, num);
            } else {
                return IntField.newSetQuery(fieldName, in);
            }
        }
    ...
    private Query getLongIn(final String fieldName, final String value) {
        ...
        if (in.length > 0) {
            if (in.length == 1) {
                final long num = in[0];
                return LongField.newExactQuery(fieldName, num);
            } else {
                return LongField.newSetQuery(fieldName, in);
            }
        }
    ...
    private Query getFloatIn(final String fieldName, final String value) {
        ...
        if (in.length > 0) {
            if (in.length == 1) {
                ...
                return FloatField.newExactQuery(fieldName, num);
            } else {
                return FloatField.newSetQuery(fieldName, in);
            }
        }
    ...
    private Query getDoubleIn(final String fieldName, final String value) {
        ...
        if (in.length > 0) {
            if (in.length == 1) {
                ...
                return DoubleField.newExactQuery(fieldName, num);
            } else {
                return DoubleField.newSetQuery(fieldName, in);
            }
        }
    ...
    private Query getDateIn(final String fieldName, final String value) {
        ...
        if (in.length > 0) {
            if (in.length == 1) {
                ...
                return LongField.newExactQuery(fieldName, date);
            } else {
                return LongField.newSetQuery(fieldName, in);
            }
        }
