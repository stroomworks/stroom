...
/**
 * Provides a way to store document assets within the database.
 */
public interface DocumentAssetDao {
     ...
     */
    DocumentAssets fetchDraftAssets(String userUuid,
    ...
    /**
     * Imports live assets during import.
