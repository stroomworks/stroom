...
import stroom.document.asset.shared.DocumentAssetContent;
...
/**
 * Serverside REST handling for Document Assets.
 */
@AutoLogged(OperationType.MANUALLY_LOGGED)
public class DocumentAssetResourceImpl implements DocumentAssetResource {

    private static final LambdaLogger LOGGER = LambdaLoggerFactory.getLogger(DocumentAssetResourceImpl.class);

    /** Service that backs the resource */
    private final Provider<DocumentAssetService> serviceProvider;
    ...
    @Inject
    DocumentAssetResourceImpl(final Provider<DocumentAssetService> serviceProvider,
    ...
    @Override
    public DocumentAssets fetchDraftAssets(final String ownerId) throws RuntimeException {
        ...
        return eventLoggingService.loggedWorkBuilder()
                ...
                .withDescription("View all assets for a Document (saved or unsaved)")
    ...
    @Override
    public Boolean updateNewFile(final String ownerDocId, final DocumentAssetUpdateNewFile update)
            throws RuntimeException {
    ...
    @Override
    public Boolean updateDelete(final String ownerDocId, final DocumentAssetUpdateDelete update)
            throws RuntimeException {
        final StroomEventLoggingService eventLoggingService = eventLoggingServiceProvider.get();
    ...
    public Boolean updateRename(final String ownerDocId,
                                final DocumentAssetUpdateRename update)
            throws RuntimeException {
    ...
    @Override
    public DocumentAssetContent getDraftContent(final String ownerDocId, final String path) {
        final StroomEventLoggingService eventLoggingService = eventLoggingServiceProvider.get();
        ...
        return eventLoggingService.loggedWorkBuilder()
                ...
                .withSimpleLoggedResult(() -> {
                    try {
                        ...
                        return new DocumentAssetContent(content, editorMode);
                    } catch (final IOException e) {
                        throw new RuntimeException(e);
                    } catch (final Throwable t) {
    ...
    @Override
    public Boolean saveAs(final String fromOwnerDocId, final DocumentAssetSaveAsParameters updateParameters) {
        final StroomEventLoggingService eventLoggingService = eventLoggingServiceProvider.get();
