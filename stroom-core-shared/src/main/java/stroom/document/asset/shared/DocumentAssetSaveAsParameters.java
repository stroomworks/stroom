...
@Description(
        "Parameter for DocumentAssetResource.saveAs()"
)
@JsonPropertyOrder({
        "toOwnerDocId",
        "updatedContentPath",
...
public class DocumentAssetSaveAsParameters {
     ...
     */
    @JsonCreator
    public DocumentAssetSaveAsParameters(
    ...
    public boolean equals(final Object o) {
        ...
        final DocumentAssetSaveAsParameters that = (DocumentAssetSaveAsParameters) o;
