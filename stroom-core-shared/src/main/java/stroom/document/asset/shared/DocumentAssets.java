...
public class DocumentAssets {
    ...
    @JsonProperty
    private final List<DocumentAsset> assets = new ArrayList<>();
     ...
     */
    public DocumentAssets(final String ownerId) {
        this(ownerId, null);
    }
    ...
    /**
     * Note that the server stores 'draft' data for the document assets in a separate table.
     ...
     */
    public void addAsset(final DocumentAsset asset) {
        assets.add(asset);
    }
     ...
     */
    public void addAllAssets(final Collection<DocumentAsset> assets) {
        this.assets.addAll(assets);
    }
     ...
     *         Never returns null.
     */
    public List<DocumentAsset> getAssets() {
