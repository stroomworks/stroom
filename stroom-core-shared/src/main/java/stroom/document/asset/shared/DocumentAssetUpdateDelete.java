...
public class DocumentAssetUpdateDelete {
    @JsonProperty
    ...
    @JsonCreator
    public DocumentAssetUpdateDelete(
    ...
    public boolean equals(final Object o) {
        ...
        final DocumentAssetUpdateDelete that = (DocumentAssetUpdateDelete) o;
    ...
    public String toString() {
        return "DocumentAssetUpdateDelete{" +
               "path='" + path + '\'' +
               ", folder=" + folder +
               '}';
    }
