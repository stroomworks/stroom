...
/**
 * Wraps data together for DocumentAssetResource.updateRename().
 */
@Description(
        "Parameter for DocumentAssetResource.updateRename"
)
@JsonPropertyOrder({
        "oldPath",
        "newPath",
...
public class DocumentAssetUpdateRename {
    @JsonProperty
    ...
    @JsonCreator
    public DocumentAssetUpdateRename(
    ...
    public boolean equals(final Object o) {
        ...
        final DocumentAssetUpdateRename that = (DocumentAssetUpdateRename) o;
    ...
    public String toString() {
        return "DocumentAssetUpdateRename{" +
               "oldPath='" + oldPath +
               "', newPath='" + newPath +
               "', isFolder=" + folder +
               '}';
