...
@Singleton
public class OpenAIModelStoreImpl implements OpenAIModelStore {

    private final Store<OpenAIModelDoc> store;
    ...
    @Override
    public OpenAIModelDoc readDocument(final DocRef docRef) {
        return store.readDocument(docRef);
    }

    @Override
    public OpenAIModelDoc writeDocument(final OpenAIModelDoc document) {
