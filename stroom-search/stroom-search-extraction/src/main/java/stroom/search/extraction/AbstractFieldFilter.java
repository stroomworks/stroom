...
public abstract class AbstractFieldFilter extends AbstractXMLFilter {
    ...
    private DenseVectorFieldConfig.Builder denseVectorFieldConfigBuilder;
    private DocRef.Builder docRefBuilder;
        ...
        if (denseVectorFieldConfigBuilder != null) {
            if (docRefBuilder != null) {
                if ("embeddingModelRef".equalsIgnoreCase(localName)) {
                    ...
                    docRefBuilder.uuid(content.toString());
                } else if ("name".equalsIgnoreCase(localName)) {
                    docRefBuilder.name(content.toString());
                }
            } else {
                if (DENSE_VECTOR.equalsIgnoreCase(localName)) {
                    currentFieldBuilder.denseVectorFieldConfig(denseVectorFieldConfigBuilder.build());
                    denseVectorFieldConfigBuilder = null;
                } else if ("vectorSimilarityFunction".equalsIgnoreCase(localName)) {
                    denseVectorFieldConfigBuilder
                            .vectorSimilarityFunction(VectorSimilarityFunctionType.valueOf(content.toString()));
                } else if ("segmentSize".equalsIgnoreCase(localName)) {
                    denseVectorFieldConfigBuilder
                            .segmentSize(Integer.parseInt(content.toString()));
                } else if ("overlapSize".equalsIgnoreCase(localName)) {
                    denseVectorFieldConfigBuilder
                            .overlapSize(Integer.parseInt(content.toString()));
