...
//        builder.addElement(ELEM_TYPE, "test1", "test1");
//        builder.addElement(ELEM_TYPE, "test2", "test2");
...
//    void testComplex() {
//        final PipelineDataBuilder builder = new PipelineDataBuilder();
//        builder.addElement(ELEM_TYPE, "test1", "Test Element 1");
//        builder.addElement(ELEM_TYPE, "test2", "Test Element 2");
//        builder.addElement(ELEM_TYPE, "test3", "test3");
//        builder.addElement(ELEM_TYPE, "test4", "test4");
//        builder.addLink("test1", "test2");
//        builder.addLink("test2", "test3");
//        builder.addLink("test3", "test4");
//        builder.removeElement("test4");
//
...
//        final PipelineDataBuilder builder = new PipelineDataBuilder();
//        builder.addElement(ELEM_TYPE, "test", "test");
...
//        base.addElement(ELEM_TYPE, "test1", "test1");
//        base.addElement(ELEM_TYPE, "test2", "test2");
...
//        override.addElement(ELEM_TYPE, "test3", "test3");
