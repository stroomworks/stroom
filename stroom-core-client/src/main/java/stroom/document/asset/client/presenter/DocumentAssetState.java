 ...
 */
public class DocumentAssetState {

    /** The tree item currently being edited */
    private DocumentAssetTreeItem editItem = null;
     ...
     */
    public void onSelectNewItemAfterSaveOldItem(final DocumentAssetTreeItem selectedItem,
     ...
     */
    public DocumentAssetTreeItem getEditItem() {
        return editItem;
    }
