 ...
 */
public class DocumentAssetAddItemDialogPresenter
        extends MyPresenterWidget<DocumentAssetAddItemDialogPresenter.DocumentAssetAddItemDialogView>
    ...
    @Inject
    public DocumentAssetAddItemDialogPresenter(final EventBus eventBus,
                                                     final DocumentAssetAddItemDialogView view) {
        super(eventBus, view);
    }
    ...
    public interface DocumentAssetAddItemDialogView extends View {
