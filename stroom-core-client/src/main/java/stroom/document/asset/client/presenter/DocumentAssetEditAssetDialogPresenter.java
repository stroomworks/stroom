...
public class DocumentAssetEditAssetDialogPresenter
        extends MyPresenterWidget<DocumentAssetEditAssetDialogPresenter.DocumentAssetEditAssetDialogView>
    ...
    @Inject
    public DocumentAssetEditAssetDialogPresenter(final EventBus eventBus,
                                                       final DocumentAssetEditAssetDialogView view) {
        super(eventBus, view);
    }
    ...
    public interface DocumentAssetEditAssetDialogView extends View {

        /**
         * Sets the tree item for editing.
         */
        void setTreeItem(DocumentAssetTreeItem assetTreeItem);
